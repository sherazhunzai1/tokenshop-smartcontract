...
interface TokenshopNFTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "modifyTokenRoyalities(uint256,uint24)": FunctionFragment;
    ...
    "setFeeAccount(address)": FunctionFragment;
    "setPrimaryPlatformBPs(uint24)": FunctionFragment;
    "setSecondaryPlatformBPs(uint24)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "modifyTokenRoyalities",
  ...
  encodeFunctionData(
    functionFragment: "setFeeAccount",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "setPrimaryPlatformBPs",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setSecondaryPlatformBPs",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class TokenshopNFT extends BaseContract {
  ...
  interface: TokenshopNFTInterface;
  ...
  functions: {
    ...
    getStateInfo(
      ...
      [string, boolean, number, number, number, string] & {
        marketplaceFeeWallet: string;
    ...
    setPrimaryPlatformBPs(
      _bps: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setSecondaryPlatformBPs(
      _bps: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
